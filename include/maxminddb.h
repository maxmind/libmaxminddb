...
#define MMDB_DBG_CARP(...)
    ...
    extern int MMDB_resolve_address(const char *host, int ai_family, int ai_flags,
                         void *ip);
    ...
    extern int MMDB_vget_value(MMDB_entry_s *start, MMDB_entry_data_s *entry_data,
                    va_list params);
    extern void MMDB_get_tree(MMDB_entry_s *start, MMDB_decode_all_s **decode_all);
