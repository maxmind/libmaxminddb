...
LOCAL void *
mmdb_memmem (const void *haystack, size_t haystack_len, const void *needle,
        size_t needle_len);
LOCAL char *
mmdb_strdup(const char *s);
LOCAL char *
mmdb_strndup (const char *s, size_t n);
 ...
 * libiberty source, which is licenses under LGPL 2.1.
 *
