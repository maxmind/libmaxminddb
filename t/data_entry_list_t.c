...
char *dup_entry_or_bail(MMDB_entry_data_s entry_data)
{
                                         ...
                                         *entry_data_list)
{
    ...
    cmp_ok(array->entry_data.type, "==", MMDB_DTYPE_ARRAY,
    ...
    cmp_ok(idx0->entry_data.type, "==", MMDB_DTYPE_UINT32,
    ...
    cmp_ok(idx1->entry_data.type, "==", MMDB_DTYPE_UINT32,
    ...
    cmp_ok(idx2->entry_data.type, "==", MMDB_DTYPE_UINT32,
                                           ...
                                           *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_BOOLEAN,
                                         ...
                                         *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_BYTES,
                                          ...
                                          *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_DOUBLE,
                                         ...
                                         *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_FLOAT,
                                         ...
                                         *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_INT32,
                                          ...
                                          *entry_data_list)
{
    ...
    cmp_ok(arrayX->entry_data.type, "==", MMDB_DTYPE_ARRAY,
                                                 ...
                                                 *entry_data_list)
{
    ...
    cmp_ok(mapX_key->entry_data.type, "==", MMDB_DTYPE_UTF8_STRING,
           "found a map key in 'map{mapX}'");
    char *mapX_key_name = dup_entry_or_bail(mapX_key->entry_data);

    if (strcmp(mapX_key_name, "utf8_stringX") == 0) {
        MMDB_entry_data_list_s *mapX_value = entry_data_list =
            entry_data_list->next;
        cmp_ok(mapX_value->entry_data.type, "==", MMDB_DTYPE_UTF8_STRING,
...
MMDB_entry_data_list_s *test_map_value(MMDB_entry_data_list_s *entry_data_list)
{
    ...
    cmp_ok(map->entry_data.type, "==", MMDB_DTYPE_MAP,
    ...
    cmp_ok(map_key_1->entry_data.type, "==", MMDB_DTYPE_UTF8_STRING,
           "found a map key in 'map'");
    char *map_key_1_name = dup_entry_or_bail(map_key_1->entry_data);
    ok(strcmp(map_key_1_name, "mapX") == 0, "key name is mapX");
    free(map_key_1_name);

    MMDB_entry_data_list_s *mapX = entry_data_list = entry_data_list->next;
    cmp_ok(mapX->entry_data.type, "==", MMDB_DTYPE_MAP,
                                           ...
                                           *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_UINT128,
                                         ...
                                         *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_UINT16,
                                         ...
                                         *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_UINT32,
                                         ...
                                         *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_UINT64,
                                               ...
                                               *entry_data_list)
{
    ...
    cmp_ok(value->entry_data.type, "==", MMDB_DTYPE_UTF8_STRING,
...
void run_tests(int mode, const char *description)
{
    ...
    while (1) {
        ...
        cmp_ok(key->entry_data.type, "==", MMDB_DTYPE_UTF8_STRING,
               "found a map key");

        char *key_name = dup_entry_or_bail(key->entry_data);
