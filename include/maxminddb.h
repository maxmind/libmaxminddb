...
typedef struct MMDB_search_node_s {
    ...
    extern int MMDB_open(const char *filename, uint32_t flags, MMDB_s *const mmdb);
    extern const MMDB_lookup_result_s MMDB_lookup_string(MMDB_s *const mmdb,
                                                         const char *const ipstr,
                                                         int *const gai_error,
                                                         int *const mmdb_error);
    extern const MMDB_lookup_result_s MMDB_lookup_sockaddr(
               MMDB_s *const mmdb,
    ...
    extern const char *const MMDB_lib_version(void);
    extern int MMDB_dump_entry_data_list(FILE *const stream,
                                         MMDB_entry_data_list_s *const entry_data_list,
                                         int indent);
    extern const char *const MMDB_strerror(int error_code);
